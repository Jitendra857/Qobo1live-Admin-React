...
export const adminService = {
  ...
  processSuperAdminRequest: (data: { id: string; status: 'approved' | 'rejected' | 'email_dispatched'; feedback?: string }) => api.post('/admin/super-admin-process', data),
  ...
  shutdownRoom: (id: string) => api.delete(`/admin/rooms/${id}`),
  logoutRoomHost: (id: string) => api.post(`/admin/rooms/${id}/logout-host`),
  getLiveStreams: () => api.get('/admin/live-streams'),
  endLiveStream: (id: string) => api.delete(`/admin/live-streams/${id}`),
  shutdownLiveStream: (id: string) => api.delete(`/admin/live-streams/${id}`),
  logoutLiveStreamHost: (id: string) => api.post(`/admin/live-streams/${id}/logout-host`),
