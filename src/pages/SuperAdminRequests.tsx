        ...
        <div style={{
          ...
          <form onSubmit={handleSendInvite} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <button 
              ...
              onMouseOver={(e) => !inviting && (e.currentTarget.style.transform = 'translateY(-2px)')}
              onMouseOut={(e) => !inviting && (e.currentTarget.style.transform = 'none')}
            >
          ...
          <div style={{ background: '#ffffff', borderRadius: '16px', padding: '32px', maxWidth: '450px', width: '100%', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25)', animation: 'slideIn 0.3s cubic-bezier(0.16, 1, 0.3, 1)' }}>
            ...
            <div style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end' }}>
              ...
              <button 
                ...
                onMouseOver={(e) => !(processing || !feedback.trim()) && (e.currentTarget.style.background = '#dc2626')}
                onMouseOut={(e) => !(processing || !feedback.trim()) && (e.currentTarget.style.background = '#ef4444')}
              >
